...
<div class="container"><br>
    <div class="card">
        ...
        <p class="card-text text-center"><a href="${href}" class="btn btn-primary">Baixar o arquivo</a></p><br>`;
    $('#content').html(content);
}
...
<div class="container"><br>
    <div class="card">
        ...
        <p class="card-text text-center"><a href="${url}" class="btn btn-primary">
o arquivo</a></p><br>
    </div>
</div>
    `;
