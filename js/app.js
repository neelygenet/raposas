...
<div class="container" style="width: auto; padding: 0 10px;"><p style="text-align: center;">Construído com <i class="fa fa-heart" title="amor" style="color: #dc3545!important;"></i> e <i
...
<li class="nav-item">
    <a class="nav-link" href="https://raposas.net/0:/Torrents/"><i class="fas fa-save"
            class="basicIcon"></i> Torrents</a>
</li>

<li class="nav-item">
    <a class="nav-link" href="https://raposas.net/0:/Flashcards/"><i class="fas fa-hat-wizard"
...
<li class="nav-item">
    <a class="nav-link" href="https://t.me/raposascanal" target="_blank"><i class="fab fa-telegram"></i>
        Telegram</a>
</li>`;
...
function append_files_to_list(path, files) {
    ...
    for (i in files) {
        ...
        if (item['mimeType'] == 'application/vnd.google-apps.folder') {
            ...
            html += ` <a class="list-group-item-action" style="text-decoration: none; color: ${UI.css_a_tag_color};" href="${pn}">${item.name}</a>${UI.display_size ? `<span class="badge bg-primary float-sm-end"> ` + item['size'] + ` </span>` : ``}${UI.display_time ? ` <span class="badge bg-info float-sm-end"> ` + item['modifiedTime'] + ` </span>` : ``}</div>`;
        }
    }
...
<script src="https://cdn.jsdelivr.net/gh/neelygenet/raposas@2.0.0/js/ace/ace.js"></script>
<script src="https://cdn.jsdelivr.net/gh/neelygenet/raposas@2.0.0/js/ace/ext-language_tools.js"></script>`;
            $('#content').html(content);
        });
...
<!-- <div class="btn-group text-center">
    <a href="http://drive.google.com/uc?export=download&id=${obj.id}" type="button" class="btn btn-primary">Download</a>
</div>
<button onclick="copyFunction()" onmouseout="outFunc()" class="btn btn-success"> <span class="tooltiptext" id="myTooltip">Copiar</span> </button> -->
<br>
  </div>
...
<div class="btn-group text-center">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="${inline_url}" target="_blank">Imprimir</a></div>
  </div>
...
function file_image(path) {
    ...
    if (target_children) {
        ...
        if (target_children.length > 0 && target_children.includes(path)) {
            ...
            targetText = `
                              ${prevchild ? `<a class="btn btn-primary" href="${prev_child}?a=view" role="button">Anterior</a>` : ``}
                              ${nextchild ? `<a class="btn btn-primary" href="${next_child}?a=view" role="button">Próxima</a>` : ``}
                  `;
        }
    }
    $.post("",
