...
function nav() {
  ...
  <a class="navbar-brand" href="/0:/">${UI.logo_image ? '<img border="0" alt="'+UI.company_name+'" src="'+UI.logo_link_name+'" height="'+UI.height+'" width="'+UI.logo_width+'">' : UI.logo_link_name}</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      <li class="nav-item">
        <a class="nav-link" href="/0:/">Início</a>
      </li>`;
...
<li class="nav-item">
    <a class="nav-link" href="https://raposas.net/0:/Torrents/" target="_blank"><i class="fas fa-save"
            class="basicIcon"></i> Torrents</a>
</li>
<li class="nav-item">
    <a class="nav-link" href="https://raposas.net/0:/Flashcards/" target="_blank"><i class="fas fa-hat-wizard"
...
function list(path) {
  ...
  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb" id="folderne"><li class="breadcrumb-item"><a href="/${cur}:/">Início</a></li>`;
...
function file_video(path) {
        ...
        <div class="text-center">
            ...
            <script>
                document.getElementById("folderne").innerHTML = decodeURI(this.window.location.href.substring(window
                    ...
                    .replace('?a=view', '?download');
            </script>
            <video width="100%" height="100%" id="player" controls
                data-poster="https://raw.githubusercontent.com/neelygenet/raposas/main/images/seo-logo-black.png">
    ...
    <div class="card-body">
        ...
        <button onclick="copyFunction()" onmouseout="outFunc()" class="btn btn-success"> <span class="tooltiptext"
                id="myTooltip">Copiar</span> </button>
        <br>
    </div>
</div>
</div>
...
function file_audio(path) {
  ...
  <div class="${UI.file_view_alert_class}" id="file_details" role="alert">${obj.name}<br>${size}</div>
        ...
        O seu navegador não possui suporte para execução de áudios.
        </audio>
        </div>
        <script type="text/javascript">
        const player = new Plyr('#player');
        ...
        let next_child = (cur + 1 < len) ? target_children[cur + 1] : null;
          ...
          if (next_child == null) {
            ...
            targetText = `
                              ...
                              ${nextchild ? `<a class="btn btn-primary" href="${next_child}?a=view" role="button">Próximo</a>` : ``}
                  `;
    }
          }
    $.post("",
