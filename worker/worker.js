 ...
 */
const uiConfig = {
    "version": "v1.2.0", // don't touch this one. get latest code using generator at https://generator.driveindex.ga
    // If you're using Image then set to true, If you want text then set it to false
    "logo_image": true, // true if you're using image link in next option.
    // if logo is true then link otherwise just text for name
    "logo_link_name": "https://cdn.jsdelivr.net/gh/neelygenet/raposas@v1.1.2/images/logo.png",
...
<head>
  ...
  <link rel="icon" href="${uiConfig.jsdelivr_cdn_src}@${uiConfig.version}/images/logo.png">
  <script>
  ...
  <script async defer data-website-id="cecece1d-7dba-4f15-b0c6-2dd5816ac941" src="https://analytics.raposas.net/umami.js"></script>
  ...
  <link rel="stylesheet" href="${uiConfig.jsdelivr_cdn_src}@${uiConfig.version}/css/style.css">
  ...
  <script defer src="${uiConfig.jsdelivr_cdn_src}@${uiConfig.version}/dist/fontawesome.js"></script>
</head>
<body>
</body>
  <script src="${uiConfig.jsdelivr_cdn_src}@${uiConfig.version}/dist/popper.min.js"></script>
  <script src="${uiConfig.jsdelivr_cdn_src}@${uiConfig.version}/js/bootstrap.min.js"></script>
</html>`;
};

const unauthorized = `<html>
<head><title>401 Não autorizado</title></head>
<body>
<center><h1>401 Não autorizado</h1></center>
<hr><center>nginx/1.18.0</center>
<center>Por favor, entre em contato com a <a href="${uiConfig.unauthorized_owner_link}">Equipe Raposas</a> pelo e-mail ${uiConfig.unauthorized_owner_email}</center>
</body>
</html>`
