...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/neelygenet/raposas@${uiConfig.version}/css/mdui-style.min.css">
  <script src="https://cdn.jsdelivr.net/gh/neelygenet/raposas@${uiConfig.version}/dist/jquery.min.js"></script>
  <link href="https://cdn.jsdelivr.net/gh/neelygenet/raposas@${uiConfig.version}/plyr/plyr.min.css" rel="stylesheet" />
  <script src="https://cdn.jsdelivr.net/gh/neelygenet/raposas@${uiConfig.version}/plyr/plyr.min.js"></script>
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/neelygenet/raposas@${uiConfig.version}/css/style.min.css">
  <style>${uiConfig.display_size ? '' : '.csize{display:none;}'}${uiConfig.display_time ? '' : '.cmtime{display:none;}'}</style>
  <script src="https://cdn.jsdelivr.net/gh/neelygenet/raposas@${uiConfig.version}/js/app.min.js"></script>
  <script src="https://cdn.jsdelivr.net/gh/neelygenet/raposas@${uiConfig.version}/js/mdui.min.js"></script>
  <script src="//cdn.jsdelivr.net/npm/markdown-it@10.0.0/dist/markdown-it.min.js"></script>
  <script defer src="https://cdn.jsdelivr.net/gh/FortAwesome/Font-Awesome@5.15.3/js/all.min.js"></script>
</head>
<body id="main">
</body>
<script src="https://cdn.jsdelivr.net/gh/neelygenet/raposas@${uiConfig.version}/js/bootstrap.min.js"></script>
</html>`;
};
